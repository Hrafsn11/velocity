        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="card h-100 border border-dashed">
                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                    <div class="mb-3 p-3 rounded-circle bg-label-secondary">
                        <i class="ti ti-plus ti-lg"></i>
                    </div>
                    <h5 class="mb-1">Create New Workspace</h5>
                    <p class="text-muted mb-3">Add a new project to track your progress</p>
